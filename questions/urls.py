...
urlpatterns = [
    ...
    path("<int:question_id>/", question_detail, name="question_detail"),  # Просмотр вопроса и ответов
    path("<int:question_id>/add-answer/", add_answer, name="add_answer"),  # Форма для добавления ответа
